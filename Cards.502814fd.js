...
},{"process":"../node_modules/process/browser.js"}],"../UIKit/Cards/Cards.js":[function(require,module,exports) {
'use strict';
...
$(document).ready(function () {
  //------datepicker's logic------//
  {
    var datepicker = $('#arrival').datepicker().data('datepicker'); //inputs

    var firstdate = $('#arrival');
    var lastdate = $('#leaving'); //buttons for inputs
...

  {
    ...
    var guests_count = {
      ...
      minus: function minus(guest_type) {
        switch (guest_type) {
          case 'adult':
      ...
      check: function check(guest_type) {
        if (guest_type == 'adult') {
          return this.adult;
        }

        if (guest_type == 'children') return this.children;
        if (guest_type == 'baby') return this.baby;
      },
    ...
    plus_button.on('click', function () {
      ...
      var guest_type = $(this).parent('div').attr('data-guests-type');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../UIKit/Cards/Cards.js"], null)
//# sourceMappingURL=/Cards.502814fd.js.map